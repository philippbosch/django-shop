...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('shop_product', (
            ...
            ('unit_price', self.gf('shop.util.fields.CurrencyField')(default='0.00', max_digits=12, decimal_places=2)),
        ...
        db.create_table('shop_order', (
            ...
            ('order_subtotal', self.gf('shop.util.fields.CurrencyField')(default='0.00', max_digits=12, decimal_places=2)),
            ('order_total', self.gf('shop.util.fields.CurrencyField')(default='0.00', max_digits=12, decimal_places=2)),
        ...
        db.create_table('shop_orderitem', (
            ...
            ('unit_price', self.gf('shop.util.fields.CurrencyField')(default='0.00', max_digits=12, decimal_places=2)),
            ('quantity', self.gf('django.db.models.fields.IntegerField')()),
            ('line_subtotal', self.gf('shop.util.fields.CurrencyField')(default='0.00', max_digits=12, decimal_places=2)),
            ('line_total', self.gf('shop.util.fields.CurrencyField')(default='0.00', max_digits=12, decimal_places=2)),
        ))
        ...
        db.create_table('shop_extraorderpricefield', (
            ...
            ('value', self.gf('shop.util.fields.CurrencyField')(default='0.00', max_digits=12, decimal_places=2)),
            ('is_shipping', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        ...
        db.create_table('shop_orderpayment', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('order', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['shop.Order'])),
            ('amount', self.gf('shop.util.fields.CurrencyField')(default='0.00', max_digits=12, decimal_places=2)),
    ...
    models = {
        ...
        'shop.extraorderitempricefield': {
            ...
            'value': ('shop.util.fields.CurrencyField', [], {'default': "'0.00'", 'max_digits': '12', 'decimal_places': '2'})
        },
        ...
        'shop.order': {
            ...
            'order_subtotal': ('shop.util.fields.CurrencyField', [], {'default': "'0.00'", 'max_digits': '12', 'decimal_places': '2'}),
            'order_total': ('shop.util.fields.CurrencyField', [], {'default': "'0.00'", 'max_digits': '12', 'decimal_places': '2'}),
        ...
        'shop.orderitem': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'line_subtotal': ('shop.util.fields.CurrencyField', [], {'default': "'0.00'", 'max_digits': '12', 'decimal_places': '2'}),
            'line_total': ('shop.util.fields.CurrencyField', [], {'default': "'0.00'", 'max_digits': '12', 'decimal_places': '2'}),
            ...
            'quantity': ('django.db.models.fields.IntegerField', [], {}),
            'unit_price': ('shop.util.fields.CurrencyField', [], {'default': "'0.00'", 'max_digits': '12', 'decimal_places': '2'})
        },
        'shop.orderpayment': {
            'Meta': {'object_name': 'OrderPayment'},
            'amount': ('shop.util.fields.CurrencyField', [], {'default': "'0.00'", 'max_digits': '12', 'decimal_places': '2'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'order': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['shop.Order']"}),
